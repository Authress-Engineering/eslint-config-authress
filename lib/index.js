...
import mustUseResult from "./rules/must-use-result.js";

// Custom plugin object for Authress rules
export const authressPlugin = {
  rules: {
...
export default [
  // 1. ESLint's recommended built-in rules
  js.configs.recommended,

  // 2. The recommended rules from the 'node' plugin
  ...
  // 3. Your custom configuration object
  {
    ...
    rules: {
      // Authress custom rules — always on (no-ops gracefully without type info)
      ...
      // Merged the two `no-restricted-syntax` rules from your original config
      "no-restricted-syntax": [
        ...
        "BinaryExpression[operator='in']",
        {
          ...
          message: "Do not commit describe.only for a test.",
        },
        {
          selector: "CallExpression[callee.object.name='it'][callee.property.name='only']",
          message: "Do not commit it.only for a test.",
        },
      ],
    },
  },
